...
function App() {
  ...
  async function handleFile(
    ...
    setResult(parse(buffer, { extra: true }));
  }

  return (
    <>
      <div className="fixed isolate z-10 flex w-full items-center justify-center overflow-hidden bg-transparent px-6 py-2.5">
        <a
      ...
      <div className="relative isolate z-1 px-6 pt-14 lg:px-8">
        <div
